 ...
 * enumeration should be used in conjunction with {@link GsonBuilder} to configure a
 * {@link Gson} instance to properly translate Java field names into the desired
 * JSON field names.
 *
