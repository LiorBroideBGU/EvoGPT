...
public class FieldNamingPolicyTest {
    ...
    public void testUpperCamelCaseWithSpaces() {
        try {
            Field field = TestClass.class.getDeclaredField("testFieldWithSpace");
            String result = FieldNamingPolicy.UPPER_CAMEL_CASE_WITH_SPACES.translateName(field);
            assertEquals("Test Field With Space", result);
        } catch (Exception e) {
            e.printStackTrace();
            throw e;
        }
    ...
    static class TestClass {
        ...
        private String testFieldWithSpace; // for testing UPPER_CAMEL_CASE_WITH_SPACES
    }
}